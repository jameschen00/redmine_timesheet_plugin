...
#end
unless ProjectsHelper.included_modules.include? TimesheetPlugin::Patches::ProjectsHelperPatch
    ProjectsHelper.send(:include, TimesheetPlugin::Patches::ProjectsHelperPatch)
end
